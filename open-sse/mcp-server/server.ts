...
export function createMcpServer(): McpServer {
  ...
  // ── Graph Engineering & Context Stack Tools ──
  type GraphContextToolDef = {
    name: string;
    description: string;
  ...
  Object.values(graphContextTools as unknown as Record<string, GraphContextToolDef>).forEach(
    (toolDef) => {
      server.registerTool(
        toolDef.name,
        {
